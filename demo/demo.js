...
app.get('/', async (req, res) => {
  ...
  write(`<html>`);
  write(`<head>`);
  write(`<title>glyphpainter</title>`);
  write(`</head>`);
  write(`<body>`);
  write(`<h1>glyphpainter <a href='/coverage'>Coverage</a> <a href='/docs'>Docs</a></h1>`);
  write(`<p>This library is available as JavaScript UMD module: <a href='/parsegraph-glyphpainter.js'>parsegraph-glyphpainter.js</a></p>`);
...
app.listen(port, () => {
  console.log(`See glyphpainter build information at http://localhost:${port}`);
});
